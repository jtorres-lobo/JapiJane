var Sentry = (function (t) {
    ...
    function C(t) {
        try {
            for (
                ...
                n && e++ < 5 && !('html' === (u = M(n)) || (e > 1 && i + r.length * o + u.length >= 80));
    ...
    var J,
        z = $.__SENTRY__.logger || ($.__SENTRY__.logger = new G()),
        V = (function () {
            function t() {
            ...
            if ('function' == typeof i)
                try {
                    (i.prototype = i.prototype || {}),
                        Object.defineProperties(i, { __sentry_original__: { enumerable: !1, value: e } });
                } catch (t) {}
            t[n] = i;
        }
    }
    ...
    function tt(t, n) {
        return 'domain' === n && t && 'object' == typeof t && t.u
            ...
            ? '[Document]'
            : y((r = t)) && 'nativeEvent' in r && 'preventDefault' in r && 'stopPropagation' in r
            ? '[SyntheticEvent]'
            : 'number' == typeof t && t != t
            ? '[NaN]'
            : void 0 === t
    ...
    function nt(t, n, r, e) {
        if ((void 0 === r && (r = 1 / 0), void 0 === e && (e = new V()), 0 === r))
            return (function (t) {
                        ...
                        if (n.s !== J.PENDING) {
                            ...
                            (n.h = []),
                                t.forEach(function (t) {
                                    t.done ||
                                        (n.s === J.RESOLVED && t.onfulfilled && t.onfulfilled(n.m),
                                        n.s === J.REJECTED && t.onrejected && t.onrejected(n.m),
                                        (t.done = !0));
                                });
                        }
                    });
        ...
        ot = (function () {
            ...
            return (
                ...
                (t.prototype.add = function (t) {
                    var n = this;
                    return this.isReady()
                        ? (-1 === this._.indexOf(t) && this._.push(t),
                          t
                              .then(function () {
                                  return n.remove(t);
                              })
                          ...
                          t)
                        : it.reject(new f('Not adding Promise due to buffer limit reached.'));
                }),
            ...
            switch (((vt[t] = !0), t)) {
                case 'console':
                    !(function () {
                        ...
                        ['debug', 'info', 'warn', 'error', 'log', 'assert'].forEach(function (t) {
                            t in ft.console &&
                                K(ft.console, t, function (n) {
                                    return function () {
                                        for (var r = [], e = 0; e < arguments.length; e++) r[e] = arguments[e];
                                        pt('console', { args: r, level: t }),
                ...
                case 'dom':
                    !(function () {
                        ...
                        ft.document.addEventListener('click', xt('click', pt.bind(null, 'dom')), !1),
                            ft.document.addEventListener('keypress', jt(pt.bind(null, 'dom')), !1),
                            ['EventTarget', 'Node'].forEach(function (t) {
                                var n = ft[t] && ft[t].prototype;
                                n &&
                                    n.hasOwnProperty &&
                                    n.hasOwnProperty('addEventListener') &&
                                    (K(n, 'addEventListener', function (t) {
                                        return function (n, r, e) {
                                            return (
                                                r && r.handleEvent
                                                    ? ('click' === n &&
                                                          K(r, 'handleEvent', function (t) {
                                                              return function (n) {
                                                    ...
                                                    : ('click' === n && xt('click', pt.bind(null, 'dom'), !0)(this),
                                                      'keypress' === n && jt(pt.bind(null, 'dom'))(this)),
                                                t.call(this, n, r, e)
                                            );
                                        };
                                    }),
                    ...
                    !(function () {
                        ...
                        K(t, 'open', function (t) {
                            return function () {
                                ...
                                var e = this,
                                    i = n[1];
                                (e.__sentry_xhr__ = { method: d(n[0]) ? n[0].toUpperCase() : n[0], url: n[1] }),
                                    d(i) &&
                                ...
                                var o = function () {
                                    if (4 === e.readyState) {
                                        ...
                                        pt('xhr', { args: n, endTimestamp: Date.now(), startTimestamp: Date.now(), xhr: e });
                                    }
                                };
                                return (
                                    'onreadystatechange' in e && 'function' == typeof e.onreadystatechange
                                        ? K(e, 'onreadystatechange', function (t) {
                                              return function () {
                                                  for (var n = [], r = 0; r < arguments.length; r++) n[r] = arguments[r];
                            ...
                            K(t, 'send', function (t) {
                                return function () {
                                    for (var n = [], r = 0; r < arguments.length; r++) n[r] = arguments[r];
                                    return pt('xhr', { args: n, startTimestamp: Date.now(), xhr: this }), t.apply(this, n);
                                };
                            });
                    })();
                    break;
                case 'fetch':
                    !(function () {
                                ...
                                if (r && 'function' == typeof r.createElement)
                                    try {
                                        ...
                                        (e.hidden = !0),
                                            ...
                                            e.contentWindow && e.contentWindow.fetch && (n = ct(e.contentWindow.fetch)),
                        ...
                        K(ft, 'fetch', function (t) {
                            return function () {
                                for (var n = [], r = 0; r < arguments.length; r++) n[r] = arguments[r];
                                var e = { args: n, fetchData: { method: yt(n), url: mt(n) }, startTimestamp: Date.now() };
                                return (
                                    pt('fetch', u({}, e)),
                                    t.apply(ft, n).then(
                                        function (t) {
                                            return pt('fetch', u({}, e, { endTimestamp: Date.now(), response: t })), t;
                                        },
                                        function (t) {
                                            throw (pt('fetch', u({}, e, { endTimestamp: Date.now(), error: t })), t);
                                        }
                                    )
                                );
                            };
                    ...
                    !(function () {
                        ...
                        (ft.onpopstate = function () {
                            ...
                            var r = ft.location.href,
                                e = st;
                            if (((st = r), pt('history', { from: e, to: r }), i)) return i.apply(this, t);
                        }),
                            K(ft.history, 'pushState', o),
                            K(ft.history, 'replaceState', o);
                    })();
                    break;
                case 'error':
                    (kt = ft.onerror),
                        (ft.onerror = function (t, n, r, e, i) {
                            return (
                                pt('error', { column: e, error: i, line: r, msg: t, url: n }), !!kt && kt.apply(this, arguments)
                            );
                        });
                    break;
                case 'unhandledrejection':
                    (_t = ft.onunhandledrejection),
    ...
    function dt(t) {
        t &&
            ...
            ((ht[t.type] = ht[t.type] || []), ht[t.type].push(t.callback), lt(t.type));
    }
    function pt(t, n) {
        var r, e;
        if (t && ht[t])
    ...
    function yt(t) {
        return (
            void 0 === t && (t = []),
            'Request' in ft && g(t[0], Request) && t[0].method
    ...
    function mt(t) {
        return (
            void 0 === t && (t = []),
            'string' == typeof t[0] ? t[0] : 'Request' in ft && g(t[0], Request) ? t[0].url : String(t[0])
        );
    }
    var bt,
        wt,
    ...
    var St = /^(?:(\w+):)\/\/(?:(\w+)(?::(\w+))?@)([\w\.-]+)(?::(\d+))?\/(.+)/,
        Tt = (function () {
            ...
            return (
                ...
                (t.prototype.S = function (t) {
                    ...
                    this.T({ host: a, pass: u, path: v, projectId: l, port: h, protocol: e, user: i });
                }),
                ...
                (t.prototype.O = function () {
                    ...
                    if (
                        ...
                        throw new f('Invalid Dsn: Invalid projectId ' + this.projectId);
                    if ('http' !== this.protocol && 'https' !== this.protocol)
                        throw new f('Invalid Dsn: Invalid protocol ' + this.protocol);
        ...
        Ot = (function () {
            ...
            return (
                ...
                (t.prototype.L = function (t, n, r, e) {
                    var i = this;
                    return (
                        void 0 === e && (e = 0),
                        new it(function (o, c) {
                ...
                (t.prototype.setTags = function (t) {
                    return (this.M = u({}, this.M, t)), this.U(), this;
                }),
                (t.prototype.setTag = function (t, n) {
                    var r;
                    return (this.M = u({}, this.M, (((r = {})[t] = n), r))), this.U(), this;
                }),
                (t.prototype.setExtras = function (t) {
                    return (this.A = u({}, this.A, t)), this.U(), this;
                }),
                (t.prototype.setExtra = function (t, n) {
                    var r;
                    return (this.A = u({}, this.A, (((r = {})[t] = n), r))), this.U(), this;
                }),
                ...
                (t.prototype.setContext = function (t, n) {
                    var r;
                    return (this.q = u({}, this.q, (((r = {})[t] = n), r))), this.U(), this;
                }),
                ...
                (t.prototype.update = function (n) {
                    ...
                    return (
                        n instanceof t
                            ...
                            : y(n) &&
                              ((n = n),
                              (this.M = u({}, this.M, n.tags)),
                              (this.A = u({}, this.A, n.extra)),
                              (this.q = u({}, this.q, n.contexts)),
                ...
                (t.prototype.addBreadcrumb = function (t, n) {
                    var r = u({ timestamp: H() }, t);
                    return (this.N = void 0 !== n && n >= 0 ? a(this.N, [r]).slice(-n) : a(this.N, [r])), this.U(), this;
                }),
                ...
                (t.prototype.applyToEvent = function (t, n) {
                    return (
                        this.A && Object.keys(this.A).length && (t.extra = u({}, this.A, t.extra)),
                        this.M && Object.keys(this.M).length && (t.tags = u({}, this.M, t.tags)),
                        this.C && Object.keys(this.C).length && (t.user = u({}, this.C, t.user)),
                        this.q && Object.keys(this.q).length && (t.contexts = u({}, this.q, t.contexts)),
                        this.F && (t.level = this.F),
                        this.P && (t.transaction = this.P),
                        this.X && (t.contexts = u({ trace: this.X.getTraceContext() }, t.contexts)),
                        this.W(t),
                        (t.breadcrumbs = a(t.breadcrumbs || [], this.N)),
                        (t.breadcrumbs = t.breadcrumbs.length > 0 ? t.breadcrumbs : void 0),
                        this.L(a(Dt(), this.I), t, n)
                    );
                }),
                t
            );
        ...
        Nt = (function () {
            ...
            return (
                ...
                (t.prototype.captureException = function (t, n) {
                    ...
                    return this.G('captureException', t, u({}, e, { event_id: r })), r;
                }),
                (t.prototype.captureMessage = function (t, n, r) {
                    ...
                    return this.G('captureMessage', t, n, u({}, i, { event_id: e })), e;
                }),
                (t.prototype.captureEvent = function (t, n) {
                    var r = (this.J = T());
                    return this.G('captureEvent', t, u({}, n, { event_id: r })), r;
                }),
    ...
    function At() {
        var t = Ct();
        return (
            (qt(t) && !Ut(t).isOlderThan(It)) || Lt(t, new Nt()),
            k()
                ? (function (t) {
                      try {
                          var n = Ct(),
    ...
    function Ut(t) {
        return t && t.__SENTRY__ && t.__SENTRY__.hub
            ? t.__SENTRY__.hub
            : ((t.__SENTRY__ = t.__SENTRY__ || {}), (t.__SENTRY__.hub = new Nt()), t.__SENTRY__.hub);
    }
    function Lt(t, n) {
    ...
    function captureException(t, n) {
        ...
        return Ht('captureException', t, { captureContext: n, originalException: t, syntheticException: r });
    }
    function Ft(t) {
        Ht('withScope', t);
    }
        ...
        return (
            (function (t) {
                ...
                (n[t.name] = t),
                    (function (t) {
                        -1 === Xt.indexOf(t.name) &&
                            (t.setupOnce(Rt, At), Xt.push(t.name), z.log('Integration installed: ' + t.name));
                    })(t);
            }),
            n
        );
        ...
        Bt = (function () {
            ...
            return (
                ...
                (t.prototype.captureMessage = function (t, n, r, e) {
                    ...
                    return (
                        (this.rt = !0),
                        (p(t) ? this.ut().eventFromMessage('' + t, n, r) : this.ut().eventFromException(t, r)).then(function (t) {
                    ...
                    return new it(function (r) {
                        ...
                        clearInterval(i),
                            (i = setInterval(function () {
                                n.rt ? ((e += 1), t && e >= t && r({ interval: i, ready: !1 })) : r({ interval: i, ready: !0 });
                            }, 1));
                    });
                }),
                    ...
                    var r = u(
                        ...
                        t.breadcrumbs && {
                            breadcrumbs: t.breadcrumbs.map(function (t) {
                                return u({}, t, t.data && { data: rt(t.data, n) });
                            }),
                        },
                ...
                (t.prototype.ht = function (t) {
                    ...
                    void 0 === t.environment && void 0 !== r && (t.environment = r),
                        ...
                        t.message && (t.message = E(t.message, u));
                                  ...
                                  .then(function (t) {
                                      if (null !== t) {
                                          ...
                                          if (void 0 === a) z.error('`beforeSend` method has to return `null` or a valid event.');
                                              ...
                                              if (null === (r = a))
                                                  return (
                                                      z.log('`beforeSend` returned `null`, will not send event.'), void i(null)
                                                  );
                                              e.dt(r), i(r);
                                          }
    ...
    function zt(t, n) {
        ...
        if (r) {
            var i =
                JSON.stringify({ event_id: t.event_id, sent_at: new Date(1e3 * H()).toISOString() }) +
                '\n' +
    ...
    var Vt = (function () {
            ...
            return (
                ...
                (t.prototype.kt = function (t) {
                    try {
                        ...
                        if (t.exception) {
                            var r =
                                t.exception.values && t.exception.values[0].stacktrace && t.exception.values[0].stacktrace.frames;
        ...
        Yt = Object.freeze({ __proto__: null, FunctionToString: Vt, InboundFilters: Qt }),
        Zt = '?',
        tn = /^\s*at (?:(.*?) ?\()?((?:file|https?|blob|chrome-extension|address|native|eval|webpack|<anonymous>|[-a-z]+:|.*bundle|\/).*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i,
        nn = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)?((?:file|https?|blob|chrome|webpack|resource|moz-extension).*?:\/.*?|\[native code\]|[^@]*(?:bundle|\d+\.js))(?::(\d+))?(?::(\d+))?\s*$/i,
            ...
            if (
                (n = (function (t) {
                    ...
                    for (
                        ...
                        var a = null;
                        (n = e.exec(o[c]))
                            ? (a = { url: n[2], func: n[3], args: [], line: +n[1], column: null })
                            : (n = i.exec(o[c])) &&
                              (a = {
                                  url: n[6],
                                  func: n[3] || n[4],
            ...
            if (
                (n = (function (t) {
                    ...
                    for (var n, r, e, i = [], o = t.stack.split('\n'), u = 0; u < o.length; ++u) {
                        ...
                        } else if ((r = rn.exec(o[u])))
                            e = { url: r[2], func: r[1] || Zt, args: [], line: +r[3], column: r[4] ? +r[4] : null };
                        else {
                            if (!(r = nn.exec(o[u]))) continue;
                            r[3] && r[3].indexOf(' > eval') > -1 && (n = en.exec(r[3]))
                                ? ((r[1] = r[1] || 'eval'), (r[3] = n[1]), (r[4] = n[2]), (r[5] = ''))
                                : 0 !== u || r[5] || void 0 === t.columnNumber || (i[0].column = t.columnNumber + 1),
                                (e = {
                                    url: r[3],
                                    func: r[1] || Zt,
                                    args: r[2] ? r[2].split(',') : [],
    ...
    function an(t, n) {
        try {
            return u({}, t, { stack: t.stack.slice(n) });
        } catch (n) {
            return t;
        }
    }
    ...
    function dn(n, r, e) {
        var i = yn(r, (e && e.syntheticException) || void 0, { attachStacktrace: n.attachStacktrace });
        return (
            N(i, { handled: !0, type: 'generic' }),
    ...
    function pn(n, r, e, i) {
        ...
        var o = mn(r, (i && i.syntheticException) || void 0, { attachStacktrace: n.attachStacktrace });
    ...
    function yn(t, n, r) {
        ...
        return h(t)
            ...
            ? (N(
              ...
              e)
            : (I((e = mn(t, n, r)), '' + t, void 0), N(e, { synthetic: !0 }), e);
    }
    function mn(t, n, r) {
        void 0 === r && (r = {});
        var e = { message: t };
    ...
    var bn = (function () {
            function t(t) {
                (this.options = t),
                    (this._ = new ot(30)),
                    (this.Tt = new Pt(this.options.dsn)),
                    (this.url = this.Tt.getStoreEndpointWithUrlEncodedAuth());
            }
            return (
                (t.prototype.sendEvent = function (t) {
        ...
        gn = (function (n) {
            ...
            return (
                ...
                (e.prototype.sendEvent = function (n) {
                    ...
                    var e = zt(n, this.Tt),
                        i = { body: e.body, method: 'POST', referrerPolicy: at() ? 'origin' : '' };
                    return (
                                    ...
                                    .then(function (e) {
                                        ...
                                        if (i !== t.Status.Success) {
                                            if (i === t.Status.RateLimit) {
                                                var u = Date.now();
                                                (r.Ot = new Date(u + P(u, e.headers.get('Retry-After')))),
                                                    z.warn('Too many requests, backing off till: ' + r.Ot);
                                            }
                                            o(e);
                                        } else n({ status: i });
                                    })
                                ...
                                if (4 === o.readyState) {
                                    ...
                                    if (e !== t.Status.Success) {
                                        if (e === t.Status.RateLimit) {
                                            var u = Date.now();
                                            (r.Ot = new Date(u + P(u, o.getResponseHeader('Retry-After')))),
                                                z.warn('Too many requests, backing off till: ' + r.Ot);
                                        }
                                        i(o);
                                    } else n({ status: e });
        ...
        xn = Object.freeze({ __proto__: null, BaseTransport: bn, FetchTransport: gn, XHRTransport: En }),
        jn = (function (n) {
            function e() {
            ...
            return (
                ...
                (e.prototype.bt = function () {
                    ...
                    var t = u({}, this.it.transportOptions, { dsn: this.it.dsn });
    ...
    function Sn(t, n, r) {
                ...
                throw (
                    ...
                    Ft(function (r) {
                        r.addEventProcessor(function (t) {
                            var r = u({}, t);
                            return (
                                n.mechanism && (I(r, void 0, void 0), N(r, n.mechanism)),
                                (r.extra = u({}, r.extra, { arguments: e })),
                                r
                            );
                        }),
                            captureException(t);
        ...
        (t.prototype = t.prototype || {}),
            ...
            Object.defineProperty(t, '__sentry_wrapped__', { enumerable: !1, value: sentryWrapped }),
    ...
    function Tn(t) {
        if ((void 0 === t && (t = {}), t.eventId))
            if (t.dsn) {
                ...
                (n.async = !0),
                    (n.src = new Pt(t.dsn).getReportDialogEndpoint(t)),
    ...
    var On = (function () {
            function n(t) {
                (this.name = n.id), (this.Dt = !1), (this.Rt = !1), (this.it = u({ onerror: !0, onunhandledrejection: !0 }, t));
            }
            return (
                (n.prototype.setupOnce = function () {
                    (Error.stackTraceLimit = 50),
                        this.it.onerror && (z.log('Global Handler attached: onerror'), this.It()),
                        this.it.onunhandledrejection && (z.log('Global Handler attached: onunhandledrejection'), this.Nt());
                }),
                        ...
                        (dt({
                            callback: function (r) {
                                ...
                                if (o && !_n() && !u) {
                                    ...
                                    N(a, { handled: !1, type: 'onerror' }), i.captureEvent(a, { originalException: e });
                                }
                            },
                            type: 'error',
                        }),
                ...
                (n.prototype.At = function (t) {
                    return {
                        exception: {
                            values: [
                                { type: 'UnhandledRejection', value: 'Non-Error promise rejection captured with value: ' + t },
                            ],
                        },
                    };
                }),
            ...
            return (
                (t.prototype.qt = function (t) {
                    return function () {
                        ...
                        var e = n[0];
                        return (
                            (n[0] = Sn(e, { mechanism: { data: { function: W(t) }, handled: !0, type: 'instrument' } })),
                            t.apply(this, n)
                        );
                    };
                }),
                (t.prototype.Ut = function (t) {
                    return function (n) {
                        return t.call(
                            ...
                            Sn(n, {
                                mechanism: {
                                    data: { function: 'requestAnimationFrame', handler: W(t) },
                                    handled: !0,
                                    type: 'instrument',
                                },
                            })
                            ...
                            return function (r, e, i) {
                                try {
                                    'function' == typeof e.handleEvent &&
                                        (e.handleEvent = Sn(e.handleEvent.bind(e), {
                                            mechanism: {
                                                data: { function: 'handleEvent', handler: W(e), target: t },
                                                handled: !0,
                                                type: 'instrument',
                                            },
                                        }));
                                ...
                                return n.call(
                                    ...
                                    Sn(e, {
                                        mechanism: {
                                            data: { function: 'addEventListener', handler: W(e), target: t },
                                            handled: !0,
                                            type: 'instrument',
                                        },
                                    }),
                        ...
                        return (
                            ['onload', 'onerror', 'onprogress', 'onreadystatechange'].forEach(function (t) {
                                t in e &&
                                    ...
                                    K(e, t, function (n) {
                                        var r = {
                                            mechanism: { data: { function: t, handler: W(n) }, handled: !0, type: 'instrument' },
                                        };
                                        return (
                                            n.__sentry_original__ && (r.mechanism.data.handler = W(n.__sentry_original__)),
                                            Sn(n, r)
                                        );
                                    });
                            }),
                ...
                (t.prototype.setupOnce = function () {
                    var t = S();
                    (this.it.setTimeout && K(t, 'setTimeout', this.qt.bind(this)),
                    this.it.setInterval && K(t, 'setInterval', this.qt.bind(this)),
                    this.it.requestAnimationFrame && K(t, 'requestAnimationFrame', this.Ut.bind(this)),
                    this.it.XMLHttpRequest && 'XMLHttpRequest' in t && K(XMLHttpRequest.prototype, 'send', this.Ht.bind(this)),
                    this.it.eventTarget) &&
                        (Array.isArray(this.it.eventTarget) ? this.it.eventTarget : Dn).forEach(this.Lt.bind(this));
                }),
                (t.id = 'TryCatch'),
                t
            );
        ...
        In = (function () {
            function n(t) {
                (this.name = n.id), (this.it = u({ console: !0, dom: !0, fetch: !0, history: !0, sentry: !0, xhr: !0 }, t));
            }
            return (
                ...
                (n.prototype.Ft = function (n) {
                    ...
                    if ('assert' === n.level) {
                        ...
                        (r.message = 'Assertion failed: ' + (x(n.args.slice(1), ' ') || 'console.assert')),
                            (r.data.arguments = n.args.slice(1));
                    }
                    At().addBreadcrumb(r, { input: n.args, level: n.level });
                }),
                (n.prototype.Pt = function (t) {
                    ...
                    0 !== n.length &&
                        At().addBreadcrumb({ category: 'ui.' + t.name, message: n }, { event: t.event, name: t.name });
                }),
                (n.prototype.Xt = function (t) {
                    if (t.endTimestamp) {
                        if (t.xhr.__sentry_own_request__) return;
                        At().addBreadcrumb({ category: 'xhr', data: t.xhr.__sentry_xhr__, type: 'http' }, { xhr: t.xhr });
                    } else;
                }),
                        ...
                        ((n.fetchData.url.match(/sentry_key/) && 'POST' === n.fetchData.method) ||
                            (n.error
                                ...
                                : At().addBreadcrumb(
                                      {
                                          category: 'fetch',
                                          data: u({}, n.fetchData, { status_code: n.response.status }),
                                          type: 'http',
                                      },
                ...
                (n.prototype.$t = function (t) {
                    ...
                    o.path || (o = i),
                        ...
                        At().addBreadcrumb({ category: 'navigation', data: { from: r, to: e } });
                }),
                (n.prototype.setupOnce = function () {
                    var t = this;
                    this.it.console &&
                ...
                (t.prototype.setupOnce = function () {
                    Rt(function (n) {
                        if (At().getIntegration(t)) {
                            ...
                            var r = n.request || {};
                            return (
                                (r.url = r.url || An.location.href),
                                (r.headers = r.headers || {}),
                                (r.headers['User-Agent'] = An.navigator.userAgent),
                                u({}, n, { request: r })
                            );
                        }
                        return n;
            ...
            return (
                ...
                (n.prototype.ft = function (n, r, e) {
                    return (
                        ...
                        (n.sdk = u({}, n.sdk, {
                            name: Ln,
                            packages: a((n.sdk && n.sdk.packages) || [], [{ name: 'npm:@sentry/browser', version: '5.20.1' }]),
                            version: '5.20.1',
                        })),
    ...
    return (
        ...
        (t.Integrations = Wn),
        (t.SDK_NAME = Ln),
        (t.SDK_VERSION = '5.20.1'),
        (t.Scope = Ot),
        (t.Transports = xn),
        (t.addBreadcrumb = function (t) {
            Ht('addBreadcrumb', t);
        }),
        (t.addGlobalEventProcessor = Rt),
        ...
        (t.captureMessage = function (t, n) {
            ...
            return Ht(
                ...
                u({ originalException: t, syntheticException: r }, 'string' != typeof n ? { captureContext: n } : void 0)
            );
        }),
        (t.close = function (t) {
            var n = At().getClient();
        ...
        (t.defaultIntegrations = Fn),
        (t.eventFromException = dn),
        ...
        (t.getCurrentHub = At),
        (t.getHubFromCarrier = Ut),
        (t.init = function (t) {
            if (
                (void 0 === t && (t = {}), void 0 === t.defaultIntegrations && (t.defaultIntegrations = Fn), void 0 === t.release)
            ) {
                var n = S();
